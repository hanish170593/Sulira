...
class HeartbeatView : View {
    constructor(context: Context, attr: AttributeSet?) : super(
        ...
        greenBitmap =
            BitmapFactory.decodeResource(context.resources, R.drawable.green_icon)
        redBitmap =
            BitmapFactory.decodeResource(context.resources, R.drawable.red_icon)
    }
    ...
    override fun onDraw(canvas: Canvas) {
        ...
        bitmap =
            if (HeartCheckActivity.current === HeartCheckActivity.TYPE.GREEN) greenBitmap else redBitmap
