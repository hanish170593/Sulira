...
class ProceedToPayViewModel : ViewModel() {

    var tag = ProceedToPayViewModel::class.java.simpleName!!
    ...
    fun proceedToPay(userId: String, stripeToken: String, cardId: String, planId: String) {
        userDataManager.proceedToPay(userId, stripeToken, cardId, planId)
