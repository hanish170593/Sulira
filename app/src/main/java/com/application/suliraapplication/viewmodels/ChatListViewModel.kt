...
class ChatListViewModel : ViewModel() {
    ...
    var tag = ChatListViewModel::class.java.simpleName!!
    ...
    fun getChatList(userId: String, userType: String) {
        userDataManager.getChatList(userId, userType)
            .subscribeOn(Schedulers.io())
            .observeOn(AndroidSchedulers.mainThread())
            .subscribeWith(object : DisposableObserver<ChatListModel>() {
                override fun onComplete() {

                }

                override fun onNext(response: ChatListModel) {
