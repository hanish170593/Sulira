...
class UpdateHealthConditionViewModel:ViewModel() {

    var tag = UpdateHealthConditionViewModel::class.java.simpleName!!
    ...
    fun updateHealthCondition(userId:String,healthType:String,healthValue:String){
        userDataManager.updateHealthData(userId,healthType,healthValue)
