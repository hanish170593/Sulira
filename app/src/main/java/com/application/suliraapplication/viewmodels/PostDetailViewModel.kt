...
class PostDetailViewModel : ViewModel() {
    ...
    var tag = PostDetailViewModel::class.java.simpleName!!
    ...
    fun getPostDetail(userId: String, postId: String) {
        userDataManager.getPostDetail(userId, postId)
            .subscribeOn(Schedulers.io())
            .observeOn(AndroidSchedulers.mainThread())
            .subscribeWith(object : DisposableObserver<PostDetailModel>() {
                override fun onComplete() {

                }

                override fun onNext(response: PostDetailModel) {
