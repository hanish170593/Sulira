...
class ForgetPasswordViewModel:ViewModel() {
    ...
    var tag = ForgetPasswordViewModel::class.java.simpleName!!
    ...
    fun forgetPassword(mobile:String,otp:String,password:String){
        userDataManager.forgetPassword(mobile,otp,password)
