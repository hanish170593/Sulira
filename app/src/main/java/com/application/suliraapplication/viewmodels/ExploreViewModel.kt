...
class ExploreViewModel:ViewModel() {
    ...
    var tag = ExploreViewModel::class.java.simpleName!!
    ...
    fun getExplore(userId:String){
        userDataManager.getExplore(userId)
            .subscribeOn(Schedulers.io())
            .observeOn(AndroidSchedulers.mainThread())
            .subscribeWith(object: DisposableObserver<ExploreModel>(){
                override fun onComplete() {

                }

                override fun onNext(response: ExploreModel) {
                    exploreModel=response
