...
class UpdateHealthSleepViewModel:ViewModel() {

    var tag = UpdateHealthSleepViewModel::class.java.simpleName!!
    ...
    fun updateSleepHealthLog(userId: String,healthType: String, healthValue: String, sleep_at: String,wakeup_at: String){
        userDataManager.updateSleepHealthLog(userId,healthType,healthValue,sleep_at,wakeup_at)
