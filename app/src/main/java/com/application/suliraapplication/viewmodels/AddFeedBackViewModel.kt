...
class AddFeedBackViewModel : ViewModel() {
    ...
    var tag = AddFeedBackViewModel::class.java.simpleName!!
    ...
    fun addFeedBack(userId: String, userFeedback: String, userSuggestion: String) {
        userDataManager.addFeedBack(userId, userFeedback, userSuggestion)
