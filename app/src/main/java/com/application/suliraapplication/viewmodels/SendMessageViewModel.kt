...
class SendMessageViewModel : ViewModel() {
    ...
    var tag = SendMessageViewModel::class.java.simpleName!!
    private var userDataManager: UserDataManager = UserDataManager()
    val successful: MutableLiveData<Boolean> = MutableLiveData()
    lateinit var customSuccessResponse: CustomSuccessResponse
    lateinit var message: String

    @SuppressLint("CheckResult")
    fun sendMessage(senderId: String, receiverId: String, messageText: String, chatRef: String) {
        userDataManager.sendMessage(senderId, receiverId, messageText, chatRef)
