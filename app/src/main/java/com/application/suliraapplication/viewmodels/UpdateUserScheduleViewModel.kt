...
class UpdateUserScheduleViewModel:ViewModel() {

    var tag = UpdateUserScheduleViewModel::class.java.simpleName!!
    ...
    fun updateUserSchedule(userId: String,type: String,days: String){
        userDataManager.updateUserSchedule(userId,type,days)
