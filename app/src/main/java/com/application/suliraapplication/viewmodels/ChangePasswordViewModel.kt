...
class ChangePasswordViewModel:ViewModel() {
    ...
    var tag = ChangePasswordViewModel::class.java.simpleName!!
    ...
    fun changePassword(userId:String,oldPassword:String,password:String){
        userDataManager.changePassword(userId,oldPassword,password)
