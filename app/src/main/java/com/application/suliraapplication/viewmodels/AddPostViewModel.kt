...
class AddPostViewModel:ViewModel() {
    ...
    var tag = AddPostViewModel::class.java.simpleName!!
    ...
    fun addPost(addPostCollectionModel: AddPostCollectionModel){
        userDataManager.feedPost(addPostCollectionModel)
