...
class LoginViewModel:ViewModel() {
    ...
    lateinit var loginResponse: SignUpModel
    lateinit var message: String

    @SuppressLint("CheckResult")
    fun login(phone:String,email:String, FieldType:String, Password:String, deviceToken:String, deviceType:String){
        userDataManager.login(phone,email,FieldType,Password,deviceToken,deviceType)
